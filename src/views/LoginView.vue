<template>
    <section class="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        ...
        <div class="relative z-10 w-full max-w-md px-6">
            ...
            <div class="text-center mb-8">
                <h1 class="gobold text-5xl font-bold text-white mb-2">FitApp</h1>
            ...
            <div class="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-8 border border-slate-700/50 shadow-2xl">
                ...
                <FormKit type="form" :actions="false" @submit="handleSubmit" form-class="space-y-5">
                    ...
                    <!-- Botón de envío -->
                    <button type="submit"
                        class="w-full mt-6 py-3 px-4 bg-gradient-to-r from-sky-500 to-blue-600 text-white font-semibold rounded-lg hover:from-sky-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105 active:scale-95 shadow-lg"
            ...
            <!-- Footer -->
            <p class="text-center text-slate-400 text-xs mt-6">Versión 1.0 • FitApp 2025</p>
        </div>
    </section>
</template>
